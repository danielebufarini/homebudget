...
internal fun parseIsoDateMillis(dateIso: String): Long? {
    return runCatching {
...
internal fun normalizeAmount(cleaned: String): String? {
...
internal fun hasValidDecimalShape(value: String): Boolean {
